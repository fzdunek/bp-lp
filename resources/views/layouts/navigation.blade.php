<nav x-data="{ open: false }" class="sticky top-0 z-50 w-full mb-4">
    <div class="max-w-[1218px] mx-auto px-4 sm:px-0">
        <div class="bg-white rounded-b-[20px] shadow-xl">
            ...
            <div class="px-4 sm:px-[30px] py-[10px]">
                <div class="flex justify-between items-center h-[67px]">
                    ...
                    <div class="hidden md:flex items-center space-x-6 lg:space-x-8">
                        <a href="#" class="nav-link-figma text-wild-bean-light hover:text-wild-bean-dark transition-colors duration-200 whitespace-nowrap">Mechanika</a>
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden border-t border-gray-100">
                <div class="px-4 sm:px-[30px] py-4 space-y-3">
                    <a href="#" class="nav-link-figma block text-wild-bean-light hover:text-wild-bean-dark transition-colors duration-200 py-2">Mechanika</a>
